...
class _ScrollablePositionedListState extends State<ScrollablePositionedList>
  ...
  Widget _buildContent(BuildContext context, double cacheExtent) {
    return Stack(
      children: <Widget>[
        PostMountCallback(
          key: primary.key,
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return widget.disableGestureDetector == true
          ? _buildContent(context, cacheExtent)
          : GestureDetector(
          onPanDown: (_) => _stopScroll(canceled: true),
          excludeFromSemantics: true,
          child: _buildContent(context, cacheExtent),
        );
      },
    );
  }
